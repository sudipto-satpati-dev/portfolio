...
export const OssToolCard: React.FC<OssToolCardProps> = ({ tool }) => {
  ...
  return (
    <TiltCard maxTilt={8} scale={1.02} glareOpacity={0.25} className="h-full">
      <div className="p-5 rounded-lg border border-border-subtle bg-surface hover:border-accent-primary/50 hover:shadow-card transition-all duration-300 flex flex-col justify-between h-full">
        <div className="space-y-3 [transform:translateZ(10px)]">
        ...
        {/* Footer Links */}
        <div className="flex items-center justify-between pt-4 mt-4 border-t border-border-subtle/40 font-mono text-xs [transform:translateZ(12px)]">
